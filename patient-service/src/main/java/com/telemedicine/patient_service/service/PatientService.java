...
public class PatientService {
    ...
    public String getPatientEmailById(Long id) {
        return patientRepository.findEmailById(id).orElseThrow(()->new RuntimeException("Patient not found"));
    }

    public String getPatientNameById(Long id) {
        return patientRepository.findNameById(id).orElseThrow(()->new RuntimeException("Patient not found"));
    }
}
