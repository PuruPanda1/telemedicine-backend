...
public class DoctorController {
    ...
    public ResponseEntity<String> updateDoctor(@RequestHeader(value = "X-User-Email", required = false) String email, @RequestBody DoctorDto doctorDto){
        Doctor doctor = doctorService.updateDoctor(email, doctorDto);
        if(doctor == null){
