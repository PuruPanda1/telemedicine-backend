...
public class DoctorService {
    ...
    public Doctor updateDoctor(String email, DoctorDto dto) {
        ...
        if(dto.getSpecialisation() != null) doctor.setSpecialisation(dto.getSpecialisation());

        System.out.println(dto.getSpecialisation());
