...
public class MedicalRecordController {
    ...
    @GetMapping("/doctor")
    public ResponseEntity<List<MedicalRecord>> getAllMedicalRecordsByDoctorId(@RequestParam Long doctorId){
        return ResponseEntity.ok(service.getMedicalRecordsByDoctorId(doctorId));
    }
