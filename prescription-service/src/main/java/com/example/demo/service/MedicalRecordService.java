...
//    private NotificationClient notification;
    ...
    MedicalRecordService(MedicalRecordRepository repo, PatientClient patientClient, DoctorClient doctorClient, AppointmentClient appointmentClient){
        this.repo = repo;
...
//        validate the consultation Id
        ...
        updateAppointmentStatus(medicalRecord.getConsultationId());
    ...
    private void updateAppointmentStatus(Long consultationId) {
        try {
            appointmentClient.updateAppointmentStatus(consultationId, new AppointmentStatusUpdateRequest("Completed"));
    ...
    public @Nullable List<MedicalRecord> getMedicalRecordsByDoctorId(Long doctorId) {
        List<MedicalRecord> medicalRecords = repo.findMedicalRecordsByDoctorId(doctorId);
        return medicalRecords;
    }
